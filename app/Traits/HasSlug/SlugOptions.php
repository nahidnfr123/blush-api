...
class SlugOptions
{
    ...
    public bool $replaceRouteKey = true;
    public bool $modelBindingWithBothIdAndSlug = true;
    ...
    public function replaceRouteKey(bool $replaceRouteKey = true, bool $modelBindingWithBothIdAndSlug = true): self
    {
        $this->replaceRouteKey = $replaceRouteKey;
        $this->modelBindingWithBothIdAndSlug = $modelBindingWithBothIdAndSlug;
